...
import torch
from deepsea.utils import visualize_segmentation
...
def apply_img_segmentation(img,image_size = [383,512],image_means = [0.5],image_stds= [0.5]):
    ...
    """
    model_ckpt=torch.load(os.path.join(trained_models.__path__[0],'segmentation.pth'))
