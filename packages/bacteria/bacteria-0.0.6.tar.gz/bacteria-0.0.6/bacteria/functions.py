...
def derivative(df_3d, column = 'Fluor1 sum',minus = 1, plus = 2, bar = True):
    ...
    logarithm of the derivative, and logarithm of the
    derivative normalized by volume.
    ...
    vol_dict,time_dict,bin_dict,ratio_dict = {},{},{},{}
    ...
    return vol_dict,dev_dict,time_dict,df_derivative
...
def	derivative_binning(df_deriv, derivative = 'Derivative', bins = 10 , plot_params = None, sort_by = 'Cell Cycle', print_bins = True, conf = 0.95, method = np.mean):
    """
...
def growth_rate(df_3d,column = 'Volume',norm = True,log = False,minus = 1,plus = 2,conf = .95, method = np.mean, plot_hist = False):
	...
	"""
	_,_,_,df = derivative(df_3d,column=column,minus=minus,plus=plus)
	...
	return time_ref,growth_rate_mean,ci,df
...
def plot_bins(arr,ci,column = 'Fluor1 sum',derivative = 'Derivative',sort_by = 'Cell Cycle',cmap = 'rainbow',line = 'k',ax =None):
    """
...
def plot_lineage_derivative_old(df_3d,reverse_lineage,column = 'Fluor1 sum',window = 19, order = 3, norm = True, ax = None):
	...
	time_concat = []
	data_concat = []
	vol,dev,time,_ = derivative(df_3d[df_3d['Cell ID'].isin(reverse_lineage[:-1])],column=column)
...
def lineage_derivative(df_3d, reverse_lineage, column = 'Fluor1 sum',norm = True,log = False,std = 2,window = None, order = 5, perc = .7, mode = 'nearest'):
    ...
    _,_,_,df_deriv = derivative(df_3d[df_3d['Cell ID'].isin(keys)],column=column,norm=norm,log=log)
