...
class HTTPStatus(Enum):
    ...
    DIVICE_ID_PRAM_TYPE_ERR = (400008, "请求体的参数字段类型错误", "DeviceID 字段应该是 string 类型") # 设备ID
    ...
    CAP_THRESH_FLOAT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "CapThresh 字段应该是 float 类型")  # 厨师帽检测
    ...
    CAP_THRESH_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "CapThresh 字段不符合规范，请参考接口文档说明")  # 厨师帽检测
