...
class LectricClient:
    ...
    @propagate_exception
    def create_collection(self, coll_in_spec: CollectionInSpec, exact: bool=False) -> Collection:
        """Create a vector collection

        Args:
            coll_in_spec (CollectionInSpec): The collection specification to be created
            exact (bool): Is the collection for exact lookups?
    ...
    def put_exact(self, collection_name: str,
                    ...
                    algo: str="md5",
                    file: Union[str, bytes, BinaryIO]=None, uri: str=None) -> str:
        ...
        if uri:
            ...
            return put_entry_by_file_exact_hash_collection_name_file_put.sync_detailed(
                ...
                multipart_data=BodyPutEntryByFileExactHashCollectionNameFilePut(
                    ...
                    ), foreign_key = foreign_key, algo=algo
                )
