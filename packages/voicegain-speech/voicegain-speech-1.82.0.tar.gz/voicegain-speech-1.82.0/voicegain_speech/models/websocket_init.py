...
class WebsocketInit(object):
    ...
    def __init__(self, ad_hoc=False, if_exists=None, label=None, minimum_delay=4000, name=None, protocol=None, use_stomp=True, local_vars_configuration=None):  # noqa: E501
