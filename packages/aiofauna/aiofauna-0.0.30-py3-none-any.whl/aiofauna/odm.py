...
class AsyncFaunaModel(JSONModel):
        ...
        try:
            ...
            for field in cls.__fields__.values():
                ...
                if field.field_info.extra.get("unique"):
                    ...
                    if not await _q(
                        q.exists(
                            q.index(f"{cls.__name__.lower()}_{field.name}_unique")
                        )
                    ):
    ...
    @classmethod
    async def find_unique(cls, field: str, value: Any) -> Union[AsyncFaunaModel,BaseModel]:
        """
        ...
        try:
            ...
            return ExceptionModel(message=str(exc), status="error")
    ...
    @classmethod
    async def find(cls, ref: int) -> Union[AsyncFaunaModel,BaseModel]:
        """
    ...
    async def create(self) -> Union[AsyncFaunaModel,BaseModel]:
        """
    ...
    @classmethod
    async def update(cls, ref: int, **kwargs) -> Union[AsyncFaunaModel,BaseModel]:
        """
    ...
    async def upsert(self) -> Union[AsyncFaunaModel,BaseModel]:
        """
