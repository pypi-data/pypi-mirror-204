...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from meutils.docarray.array.mixins.embed import CollateFnType
    from meutils.docarray.typing import ArrayType, AnyDNN
        ...
        **kwargs,
        ...
        for metric in metrics:
            if callable(metric):
                ...
                from meutils.docarray.math import evaluation
