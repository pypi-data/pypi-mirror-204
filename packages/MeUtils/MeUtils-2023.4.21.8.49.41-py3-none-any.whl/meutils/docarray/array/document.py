...
from meutils.docarray.array.base import BaseDocumentArray
from meutils.docarray.array.mixins import AllMixins

if TYPE_CHECKING:  # pragma: no cover
    from meutils.docarray.typing import DocumentArraySourceType
    from meutils.docarray.array.memory import DocumentArrayInMemory
    from meutils.docarray.array.sqlite import DocumentArraySqlite
    from meutils.docarray.array.annlite import DocumentArrayAnnlite
    from meutils.docarray.array.weaviate import DocumentArrayWeaviate
    from meutils.docarray.array.elastic import DocumentArrayElastic
    from meutils.docarray.array.redis import DocumentArrayRedis
    from meutils.docarray.array.milvus import DocumentArrayMilvus
    from meutils.docarray.array.opensearch import DocumentArrayOpenSearch
    from meutils.docarray.array.storage.sqlite import SqliteConfig
    from meutils.docarray.array.storage.annlite import AnnliteConfig
    from meutils.docarray.array.storage.weaviate import WeaviateConfig
    from meutils.docarray.array.storage.elastic import ElasticConfig
    from meutils.docarray.array.storage.redis import RedisConfig
    from meutils.docarray.array.storage.milvus import MilvusConfig
    from meutils.docarray.array.storage.opensearch import OpenSearchConfig
    ...
    def __new__(cls, *args, storage: str = 'memory', **kwargs):
        if cls is DocumentArray:
            if storage == 'memory':
                ...
                from meutils.docarray.array.qdrant import DocumentArrayQdrant
