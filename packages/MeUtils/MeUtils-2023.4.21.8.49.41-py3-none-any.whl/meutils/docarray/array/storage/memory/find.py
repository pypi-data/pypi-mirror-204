...
from meutils.docarray.math.helper import top_k, minmax_normalize, update_rows_x_mat_best

if TYPE_CHECKING:  # pragma: no cover
    from meutils.docarray.typing import T, ArrayType
        ...
        **kwargs,
        ...
        if callable(metric):
            ...
            if use_scipy:
                ...
                from meutils.docarray.math.distance import cdist as _cdist
