...
if TYPE_CHECKING:  # pragma: no cover
    from meutils.docarray.typing import T
    from meutils.docarray.document.strawberry_type import StrawberryDocument
...
class StrawberryMixin:
    ...
    def to_strawberry_type(self) -> 'StrawberryDocument':
        ...
        from meutils.docarray.document.strawberry_type import StrawberryDocument as SD
        from meutils.docarray.document.strawberry_type import _NameScoreItem, _NamedScore
    ...
    def from_strawberry_type(cls: Type['T'], model) -> 'T':
        ...
        for field in dataclasses.fields(model):
            ...
            if f_name == 'scores' or f_name == 'evaluations':
                from meutils.docarray.score import NamedScore
                from meutils.docarray.document.strawberry_type import _NameScoreItem
