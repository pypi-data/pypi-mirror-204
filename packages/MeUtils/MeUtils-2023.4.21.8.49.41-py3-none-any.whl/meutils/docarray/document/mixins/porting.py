...
from meutils.docarray.helper import compress_bytes, decompress_bytes
...
class PortingMixin:
    ...
    def from_dict(
        ...
        if protocol == 'jsonschema':
            from meutils.docarray.document.pydantic_model import PydanticDocument

            return cls.from_pydantic_model(PydanticDocument.parse_obj(obj, **kwargs))
        elif protocol == 'protobuf':
            from google.protobuf import json_format
            from meutils.docarray.proto.docarray_pb2 import DocumentProto
