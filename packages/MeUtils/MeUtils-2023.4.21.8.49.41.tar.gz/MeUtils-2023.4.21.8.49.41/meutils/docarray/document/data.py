...
from meutils.docarray.math.ndarray import check_arraylike_equality

if TYPE_CHECKING:  # pragma: no cover
    from meutils.docarray.score import NamedScore
    from meutils.docarray import DocumentArray, Document
    from meutils.docarray.typing import ArrayType, StructValueType, DocumentContentType
        ...
        if getattr(self, key) is None:
            ...
            if v is not None:
                if v == 'DocumentArray':
                    ...
                    from meutils.docarray.array.chunk import ChunkArray

                    setattr(
                        self, key, ChunkArray(None, reference_doc=self._reference_doc)
                    )
                elif v == 'MatchArray':
                    from meutils.docarray.array.match import MatchArray
