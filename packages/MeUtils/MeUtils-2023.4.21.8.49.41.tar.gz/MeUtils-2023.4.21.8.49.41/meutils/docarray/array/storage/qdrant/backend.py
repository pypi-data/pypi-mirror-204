...
from meutils.docarray.array.storage.base.backend import BaseBackendMixin, TypeMap
from meutils.docarray.array.storage.qdrant.helper import DISTANCES
from meutils.docarray.helper import dataclass_from_dict, random_identity
from meutils.docarray.math.helper import EPSILON

if TYPE_CHECKING:  # pragma: no cover
    from meutils.docarray.typing import DocumentArraySourceType, ArrayType
...
class BackendMixin(BaseBackendMixin):
    ...
    def _map_embedding(self, embedding: 'ArrayType') -> List[float]:
        if embedding is None:
            ...
            from meutils.docarray.math.ndarray import to_numpy_array
