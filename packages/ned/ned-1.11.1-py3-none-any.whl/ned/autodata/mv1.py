...
from ned.autodata.utils import LoggerMixin, StrPath
...
class TransformV1(LoggerMixin):
    ...
    def transform_entity(self, entity: WDEntity) -> tuple[str, ChangeStatus]:
    ...
    def try_surgery(
        self, surgery: Surgery, entity: WDEntity, entclasses: list[WDClass]
