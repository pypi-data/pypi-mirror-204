...
class DataSpace:
    ...
    def diffp(self, diffcol: str, name: str = "diff", decimals=0):
        ...
        Args:
            ...
            name (str, optional): The name of the resulting difference column. \
            Defaults to "diff".
            decimals (int, optional): The number of decimal places to round the \
            difference to. Defaults to 0.
    ...
    def cvar_(self, col: str) -> float:
        ...
        Args:
            col (str): The name of the column for which to calculate the \
    ...
    def lreg_(self, xcol: str, ycol: str, name="regression"):
        ...
        Args:
            xcol (str): The name of the x column for which to calculate the \
                linear regression.
            ycol (str): The name of the y column for which to calculate the \
                linear regression.
    ...
    def bokeh(self):
        ...
        try:
            ...
            msg_warning(
                "Please install Holoviews and Bokeh to use this chart \
                    engine: pip install holoviews bokeh"
            )
            return
