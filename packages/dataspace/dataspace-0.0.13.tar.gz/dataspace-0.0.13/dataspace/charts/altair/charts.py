...
class AltairChart(AltChart):
    ...
    def qcolormap(self, column: str, **kwargs) -> "AltairChart":
        ...
        Example:
            ...
            chart = ds.point_().qcolormap("Origin", low=0.2, high=0.8, Japan="red", \
                Europe="green", USA="blue")
    ...
    def html_header_():
        ...
        header = (
            ...
            f'<script src="https://cdn.jsdelivr.net/npm/vega-lite@{VEGALITE_VERSION}">\
                </script>',
            f'<script src="https://cdn.jsdelivr.net/npm/vega-embed@{VEGAEMBED_VERSION}\
                "></script>',
