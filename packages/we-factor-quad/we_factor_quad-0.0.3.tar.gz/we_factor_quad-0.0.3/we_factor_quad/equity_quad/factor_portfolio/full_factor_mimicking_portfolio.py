...
import universe_helper as uhelper
...
class FmpAnalyzer:
    ...
    def construct_factor_return(self,
                                ...
                                monthly_ret: pd.DataFrame) -> pd.DataFrame:
        """
        ...
        monthly_return = monthly_ret[renamed_universe_cols]
    ...
    def output_report(self,
        ...
        """
        factor_returns = self.construct_factor_return(weights_df=weights_df, monthly_ret=monthly_ret)
    ...
    def save_to_csv(self, seadrive_localpath: AnyStr, dir: AnyStr=None):
        ...
        monthly_ret = dapi.wiser_get_monthly_return(start=self.start_date, end=self.end_date,
        ...
        weights_df = dapi.wiser_fetch_fmp_weights(start_date=self.start_date, end_date=self.end_date,
                                                  seadrive_localpath=seadrive_localpath)
        factor_return = self.construct_factor_return(monthly_ret=monthly_ret, weights_df=weights_df)
        ...
        sys.to_csv(os.path.join(dir, "sys.csv"))
        residual.to_csv(os.path.join(dir, "residual.csv"))
...
def test_fmp_process():
    ...
    def test_fmp1():
        ...
        monthly_ret = dapi.wiser_get_monthly_return(start=start_date, end=end_date, seadrive_localpath=seadrive_localpath)
        weights_df = dapi.wiser_fetch_fmp_weights(start_date=start_date, end_date=end_date,
                                                  seadrive_localpath=seadrive_localpath)
        factor_return = analyzer.construct_factor_return(monthly_ret=monthly_ret, weights_df=weights_df)
    ...
    def test_fmp2():
        ...
        analyzer = FmpAnalyzer(quad)
        monthly_ret = dapi.wiser_get_monthly_return(start=start_date, end=end_date,
                                                    seadrive_localpath=seadrive_localpath)
        weights_df = dapi.wiser_fetch_fmp_weights(start_date=start_date, end_date=end_date,
                                                  seadrive_localpath=seadrive_localpath)
        factor_return = analyzer.construct_factor_return(monthly_ret=monthly_ret, weights_df=weights_df)
    ...
    def test_fmp3_alternative_universe():
        ...
        quad = FactorQuadEQ.create_factor_quad(start_date=start_date, end_date=end_date, factor_system="HF25_SRAM",
                                               local_path=seadrive_localpath)
        analyzer = FmpAnalyzer(quad)
        monthly_ret = dapi.wiser_get_monthly_return(start=start_date,
                                                    end=end_date,
                                                    seadrive_localpath=seadrive_localpath)
    ...
    def test_fmp_to_csv():
        ...
        quad = FactorQuadEQ.create_factor_quad(start_date=start_date, end_date=end_date, factor_system="HF25_SRAM",
                                               local_path=seadrive_localpath)
        quad.save_to_csv()
        FmpAnalyzer(quad).save_to_csv(seadrive_localpath)
