...
class DataJobSummary(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["job_name", "team", "description", "source_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["job_name", "team", "description", "source_url", ], str]):
