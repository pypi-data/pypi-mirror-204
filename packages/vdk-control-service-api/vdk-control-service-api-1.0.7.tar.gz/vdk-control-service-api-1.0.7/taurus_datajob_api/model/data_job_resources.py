...
class DataJobResources(
    ...
    class MetaOapg:
        ...
        class properties:
            cpu_request = schemas.Float32Schema
            cpu_limit = schemas.Float32Schema
            memory_request = schemas.Int32Schema
            memory_limit = schemas.Int32Schema
            __annotations__ = {
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        cpu_request: typing.Union[MetaOapg.properties.cpu_request, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        cpu_limit: typing.Union[MetaOapg.properties.cpu_limit, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        memory_request: typing.Union[MetaOapg.properties.memory_request, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        memory_limit: typing.Union[MetaOapg.properties.memory_limit, decimal.Decimal, int, schemas.Unset] = schemas.unset,
