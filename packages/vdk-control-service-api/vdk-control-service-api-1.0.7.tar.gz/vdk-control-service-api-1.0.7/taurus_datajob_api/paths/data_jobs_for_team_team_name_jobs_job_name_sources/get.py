...
class BaseApi(api_client.Api):
    @typing.overload
    def _data_job_sources_download_oapg(
        self,
    ...
    def _data_job_sources_download_oapg(
        ...
        """
        Download data job source code. | (Not Implemented)
...
class DataJobSourcesDownload(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def data_job_sources_download(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def data_job_sources_download(
        ...
        return self._data_job_sources_download_oapg(
