...
# %% auto 0
__all__ = ['get_page_by_id', 'get_page_definition', 'get_page_accesslist']
...
async def get_page_accesslist(auth, page_id,
    ...
    if is_expand_users:
        group_users = [user for group in res.response.get('groups') for user in group.get('users') ]    
