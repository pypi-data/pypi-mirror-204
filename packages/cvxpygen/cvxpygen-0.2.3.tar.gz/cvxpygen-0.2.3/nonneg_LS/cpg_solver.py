...
"""
Auto-generated by CVXPYgen on April 23, 2023 at 16:32:06.
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    A_coordinates = np.unique([coord[0]+coord[1]*n for coord in prob.param_dict['A'].attributes['sparsity']])
    A_value = []
    A_flat = prob.param_dict['A'].value.flatten(order='F')
    ...
    prob.var_dict['x'].value = np.array(res.cpg_prim.x).reshape(2)
