...
def nii2dicom(input_file, output_dir, accession_number=1):
    """
    Require nifti2dicom.
...
def nii2cavass(input_file, output_file, dicom_accession_number=1):
    save_path = os.path.split(output_file)[0]
    tmp_dicom_dir = os.path.join(save_path, f'{uuid4()}')
    nii2dicom(input_file, tmp_dicom_dir, dicom_accession_number)
    dicom2cavass(tmp_dicom_dir, output_file)
    shutil.rmtree(tmp_dicom_dir)


if __name__ == '__main__':
    nii2cavass('/home/ubuntu/sda1.8T/Dataset/AMOS/AMOS22/imagesTr/amos_0086.nii.gz', '/home/ubuntu/sdb1.8T/dj/amos_0086.IM0')