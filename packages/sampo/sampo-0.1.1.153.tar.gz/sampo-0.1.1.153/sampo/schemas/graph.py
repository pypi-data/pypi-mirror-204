...
class EdgeType(Enum):
    ...
    def is_dependency(self) -> bool:
        return self.value == 'FS' or self.value == 'IFS' or self.value == 'FFS'
...
class GraphNode(JSONSerializable['GraphNode']):
    ...
    def parents(self) -> List['GraphNode']:
        return list([edge.start for edge in self._parent_edges if edge.type.is_dependency])
    ...
    def children(self) -> List['GraphNode']:
        return list([edge.finish for edge in self._children_edges if edge.type.is_dependency])
