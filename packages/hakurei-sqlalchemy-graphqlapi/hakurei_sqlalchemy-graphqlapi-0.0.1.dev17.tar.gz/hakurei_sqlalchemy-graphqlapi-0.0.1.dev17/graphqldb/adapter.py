...
class GraphQLAdapter(Adapter):
    ...
    def get_data(
        ...
        cookies = {'EIToken':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..__UFNZTmNKBZsmOJEPxJQFtOjOObZtZtbPfY7XMVEH4'}
        response = requests.post(url, json=params, cookies=cookies)
        payload = response.json()
        local_timezone = dateutil.tz.gettz('America/Chicago')
        for record in payload:
            for value in record['value']:
                yield {
                    "timestamp": dateutil.parser.parse(str(value['ts'])).replace(tzinfo=local_timezone,),
                    "value": value['v']
                }
