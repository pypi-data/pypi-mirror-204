...
class AnnotationConfig(AbstractApiClass):
    ...
    def __init__(self, client, featureAnnotationConfigs=None, labels=None, statusFeature=None, commentsFeature=None):
    ...
    def to_dict(self):
        ...
        """
        return {'feature_annotation_configs': self.feature_annotation_configs, 'labels': self.labels, 'status_feature': self.status_feature, 'comments_feature': self.comments_feature}
