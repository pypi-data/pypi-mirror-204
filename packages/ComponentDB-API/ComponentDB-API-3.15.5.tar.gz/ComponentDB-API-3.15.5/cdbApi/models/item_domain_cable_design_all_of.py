...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, technical_system_list=None, assigned_item=None, is_housed=None, catalog_item=None, alternate_name=None, inventory_item=None, local_vars_configuration=None):  # noqa: E501
