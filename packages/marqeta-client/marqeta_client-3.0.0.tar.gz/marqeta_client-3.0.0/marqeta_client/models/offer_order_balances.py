...
class OfferOrderBalances(BaseModel):
    """
    OfferOrderBalances
    """
    ...
    balances: Dict[str, OfferOrderBalances] = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferOrderBalances:
        """Create an instance of OfferOrderBalances from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferOrderBalances:
        """Create an instance of OfferOrderBalances from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OfferOrderBalances.parse_obj(obj)

        _obj = OfferOrderBalances.parse_obj({
            ...
            "balances": dict(
                (_k, OfferOrderBalances.from_dict(_v))
