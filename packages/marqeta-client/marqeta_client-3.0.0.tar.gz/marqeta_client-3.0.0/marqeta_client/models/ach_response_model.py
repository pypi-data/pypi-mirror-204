...
class AchResponseModel(BaseModel):
    """
    AchResponseModel
    """
    ...
    __properties = ["created_time", "last_modified_time", "token", "account_suffix", "verification_status", "account_type", "name_on_account", "bank_name", "active", "date_sent_for_verification", "partner", "partner_account_link_reference_token", "is_default_account", "date_verified", "verification_override", "verification_notes", "user_token", "business_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AchResponseModel:
        """Create an instance of AchResponseModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AchResponseModel:
        """Create an instance of AchResponseModel from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AchResponseModel.parse_obj(obj)

        _obj = AchResponseModel.parse_obj({
