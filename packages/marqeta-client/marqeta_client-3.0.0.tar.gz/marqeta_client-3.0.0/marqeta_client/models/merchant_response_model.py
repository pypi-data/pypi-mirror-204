...
class MerchantResponseModel(BaseModel):
    ...
    partial_auth_flag: Optional[StrictBool] = True
    ...
    __properties = ["name", "active", "contact", "contact_email", "longitude", "latitude", "address1", "address2", "city", "state", "province", "zip", "phone", "country", "token", "partial_auth_flag", "created_time", "last_modified_time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MerchantResponseModel:
        """Create an instance of MerchantResponseModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MerchantResponseModel:
        """Create an instance of MerchantResponseModel from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MerchantResponseModel.parse_obj(obj)

        _obj = MerchantResponseModel.parse_obj({
            "name": obj.get("name"),
