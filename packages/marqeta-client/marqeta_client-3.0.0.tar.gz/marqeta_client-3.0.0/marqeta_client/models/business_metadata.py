...
class BusinessMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BusinessMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BusinessMetadata:
        """Create an instance of BusinessMetadata from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BusinessMetadata.parse_obj(obj)

        _obj = BusinessMetadata.parse_obj({
