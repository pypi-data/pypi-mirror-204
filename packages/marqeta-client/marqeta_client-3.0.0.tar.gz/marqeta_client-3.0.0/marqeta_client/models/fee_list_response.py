...
class FeeListResponse(BaseModel):
    ...
    data: Optional[conlist(Fee)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeeListResponse:
        """Create an instance of FeeListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeeListResponse:
        """Create an instance of FeeListResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FeeListResponse.parse_obj(obj)

        _obj = FeeListResponse.parse_obj({
            "count": obj.get("count"),
            ...
            "data": [Fee.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
