...
class GPA(BaseModel):
    ...
    __properties = ["trigger_amount", "reload_amount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GPA:
        """Create an instance of GPA from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GPA:
        """Create an instance of GPA from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GPA.parse_obj(obj)
