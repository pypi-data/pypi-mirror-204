...
class OfferOrderAggregatedBalances(BaseModel):
    """
    ...
    balances: Dict[str, OfferOrderAggregatedBalances] = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferOrderAggregatedBalances:
        """Create an instance of OfferOrderAggregatedBalances from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferOrderAggregatedBalances:
        """Create an instance of OfferOrderAggregatedBalances from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OfferOrderAggregatedBalances.parse_obj(obj)

        _obj = OfferOrderAggregatedBalances.parse_obj({
            ...
            "balances": dict(
                (_k, OfferOrderAggregatedBalances.from_dict(_v))
