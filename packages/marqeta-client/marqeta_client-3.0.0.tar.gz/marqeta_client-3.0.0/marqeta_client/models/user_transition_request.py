...
class UserTransitionRequest(BaseModel):
    ...
    __properties = ["idempotentHash", "token", "status", "reason_code", "reason", "channel", "user_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserTransitionRequest:
        """Create an instance of UserTransitionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserTransitionRequest:
        """Create an instance of UserTransitionRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UserTransitionRequest.parse_obj(obj)

        _obj = UserTransitionRequest.parse_obj({
