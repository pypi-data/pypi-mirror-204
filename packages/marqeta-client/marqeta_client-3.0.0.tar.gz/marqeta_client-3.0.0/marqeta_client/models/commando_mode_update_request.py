...
class CommandoModeUpdateRequest(BaseModel):
    """
    ...
    __properties = ["program_gateway_funding_source_token", "real_time_standin_criteria", "commando_mode_enables"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommandoModeUpdateRequest:
        """Create an instance of CommandoModeUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommandoModeUpdateRequest:
        """Create an instance of CommandoModeUpdateRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CommandoModeUpdateRequest.parse_obj(obj)

        _obj = CommandoModeUpdateRequest.parse_obj({
