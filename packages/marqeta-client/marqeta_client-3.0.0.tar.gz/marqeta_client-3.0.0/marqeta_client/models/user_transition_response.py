...
class UserTransitionResponse(BaseModel):
    """
    ...
    __properties = ["token", "status", "reason_code", "reason", "channel", "created_time", "last_modified_time", "user_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserTransitionResponse:
        """Create an instance of UserTransitionResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserTransitionResponse:
        """Create an instance of UserTransitionResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UserTransitionResponse.parse_obj(obj)

        _obj = UserTransitionResponse.parse_obj({
            "token": obj.get("token"),
