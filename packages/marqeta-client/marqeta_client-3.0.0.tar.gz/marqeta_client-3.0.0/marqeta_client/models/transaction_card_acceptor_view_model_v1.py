...
class TransactionCardAcceptorViewModelV1(BaseModel):
    """
    ...
    __properties = ["mid", "mcc", "network_mid", "mcc_groups", "name", "address", "city", "state", "zip", "postal_code", "country", "poi", "network_assigned_id", "country_of_origin"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionCardAcceptorViewModelV1:
        """Create an instance of TransactionCardAcceptorViewModelV1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionCardAcceptorViewModelV1:
        """Create an instance of TransactionCardAcceptorViewModelV1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransactionCardAcceptorViewModelV1.parse_obj(obj)

        _obj = TransactionCardAcceptorViewModelV1.parse_obj({
            "mid": obj.get("mid"),
            "mcc": obj.get("mcc"),
