...
class MsaReturns(BaseModel):
    ...
    original_order_token: StrictStr = ...
    transaction_token: StrictStr = ...
    __properties = ["token", "user_token", "business_token", "order_balances", "amount", "last_transaction_date", "start_date", "end_date", "currency_code", "active", "reward_amount", "reward_trigger_amount", "unloaded_amount", "campaign_token", "funding", "created_time", "last_modified_time", "aggregated_balances", "original_order_token", "transaction_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MsaReturns:
        """Create an instance of MsaReturns from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MsaReturns:
        """Create an instance of MsaReturns from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MsaReturns.parse_obj(obj)

        _obj = MsaReturns.parse_obj({
            "token": obj.get("token"),
