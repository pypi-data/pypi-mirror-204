...
class VelocityControlRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VelocityControlRequest:
        """Create an instance of VelocityControlRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VelocityControlRequest:
        """Create an instance of VelocityControlRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VelocityControlRequest.parse_obj(obj)

        _obj = VelocityControlRequest.parse_obj({
            "token": obj.get("token"),
            "name": obj.get("name"),
