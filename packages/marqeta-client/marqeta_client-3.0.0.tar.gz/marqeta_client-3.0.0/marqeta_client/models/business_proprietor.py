...
class BusinessProprietor(BaseModel):
    """
    BusinessProprietor
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BusinessProprietor:
        """Create an instance of BusinessProprietor from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BusinessProprietor:
        """Create an instance of BusinessProprietor from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BusinessProprietor.parse_obj(obj)

        _obj = BusinessProprietor.parse_obj({
