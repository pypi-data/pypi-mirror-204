...
class Result(BaseModel):
    ...
    codes: Optional[conlist(ResultCode)] = None
    __properties = ["status", "codes"]
    ...
    def from_dict(cls, obj: dict) -> Result:
        ...
        _obj = Result.parse_obj({
            ...
            "codes": [ResultCode.from_dict(_item) for _item in obj.get("codes")] if obj.get("codes") is not None else None
        })
        return _obj
