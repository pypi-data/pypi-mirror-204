...
class AuthControlRequest(BaseModel):
    """
    AuthControlRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthControlRequest:
        """Create an instance of AuthControlRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthControlRequest:
        """Create an instance of AuthControlRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AuthControlRequest.parse_obj(obj)

        _obj = AuthControlRequest.parse_obj({
            "token": obj.get("token"),
            "name": obj.get("name"),
