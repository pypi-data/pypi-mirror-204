...
class BankAccountFundingSourceModel(FundingSourceModel):
    ...
    __properties = ["token", "active", "is_default_account", "created_time", "last_modified_time", "type", "user_token", "business_token", "account_suffix", "account_type", "name_on_account", "routing_number", "verification_status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountFundingSourceModel:
        """Create an instance of BankAccountFundingSourceModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountFundingSourceModel:
        """Create an instance of BankAccountFundingSourceModel from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BankAccountFundingSourceModel.parse_obj(obj)

        _obj = BankAccountFundingSourceModel.parse_obj({
            "token": obj.get("token"),
