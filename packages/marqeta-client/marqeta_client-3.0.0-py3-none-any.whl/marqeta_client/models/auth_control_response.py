...
class AuthControlResponse(BaseModel):
    """
    AuthControlResponse
    """
    ...
    merchant_scope: Optional[AuthControlMerchantScope] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthControlResponse:
        """Create an instance of AuthControlResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthControlResponse:
        """Create an instance of AuthControlResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AuthControlResponse.parse_obj(obj)

        _obj = AuthControlResponse.parse_obj({
            "token": obj.get("token"),
            "name": obj.get("name"),
            "association": SpendControlAssociation.from_dict(obj.get("association")) if obj.get("association") is not None else None,
            "merchant_scope": AuthControlMerchantScope.from_dict(obj.get("merchant_scope")) if obj.get("merchant_scope") is not None else None,
