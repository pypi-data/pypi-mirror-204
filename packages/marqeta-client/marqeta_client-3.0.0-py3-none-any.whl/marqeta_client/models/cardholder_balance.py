...
class CardholderBalance(BaseModel):
    """
    CardholderBalance
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardholderBalance:
        """Create an instance of CardholderBalance from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardholderBalance:
        """Create an instance of CardholderBalance from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CardholderBalance.parse_obj(obj)

        _obj = CardholderBalance.parse_obj({
