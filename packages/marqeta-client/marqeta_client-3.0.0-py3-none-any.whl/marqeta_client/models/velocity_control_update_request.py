...
class VelocityControlUpdateRequest(BaseModel):
    """
    ...
    amount_limit: Optional[Union[confloat(ge=0, strict=True), conint(ge=0, strict=True)]] = None
    velocity_window: Optional[StrictStr] = None
    active: Optional[StrictBool] = None
    __properties = ["token", "name", "association", "merchant_scope", "usage_limit", "approvals_only", "include_purchases", "include_withdrawals", "include_transfers", "include_cashback", "include_credits", "money_in_transaction", "currency_code", "amount_limit", "velocity_window", "active"]
    ...
    def velocity_window_validate_enum(cls, v):
        ...
        if v not in ('DAY', 'WEEK', 'MONTH', 'QUARTER', 'YEAR', 'LIFETIME', 'TRANSACTION'):
            raise ValueError("must be one of enum values ('DAY', 'WEEK', 'MONTH', 'QUARTER', 'YEAR', 'LIFETIME', 'TRANSACTION')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VelocityControlUpdateRequest:
        """Create an instance of VelocityControlUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VelocityControlUpdateRequest:
        """Create an instance of VelocityControlUpdateRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VelocityControlUpdateRequest.parse_obj(obj)

        _obj = VelocityControlUpdateRequest.parse_obj({
            "token": obj.get("token"),
            "name": obj.get("name"),
