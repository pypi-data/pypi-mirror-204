...
class GpaRequest(BaseModel):
    ...
    funding_source_token: constr(strict=True, max_length=36, min_length=1) = ...
    ...
    __properties = ["tags", "memo", "token", "user_token", "business_token", "amount", "currency_code", "funding_source_token", "funding_source_address_token", "fees"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GpaRequest:
        """Create an instance of GpaRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GpaRequest:
        """Create an instance of GpaRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GpaRequest.parse_obj(obj)

        _obj = GpaRequest.parse_obj({
            "tags": obj.get("tags"),
            "memo": obj.get("memo"),
            "token": obj.get("token"),
