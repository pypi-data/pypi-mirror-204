...
class AutoReloadResponseModel(BaseModel):
    """
    ...
    __properties = ["token", "active", "funding_source_token", "funding_source_address_token", "association", "order_scope", "currency_code", "created_time", "last_modified_time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoReloadResponseModel:
        """Create an instance of AutoReloadResponseModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoReloadResponseModel:
        """Create an instance of AutoReloadResponseModel from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AutoReloadResponseModel.parse_obj(obj)

        _obj = AutoReloadResponseModel.parse_obj({
            "token": obj.get("token"),
