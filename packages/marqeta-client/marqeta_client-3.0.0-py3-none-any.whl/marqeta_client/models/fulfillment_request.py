...
class FulfillmentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FulfillmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FulfillmentRequest:
        """Create an instance of FulfillmentRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FulfillmentRequest.parse_obj(obj)

        _obj = FulfillmentRequest.parse_obj({
