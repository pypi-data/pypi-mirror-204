...
class SimulatePinDebitAuthRequest(BaseModel):
    """
    ...
    __properties = ["card_token", "amount", "settlement_currency", "local_amount", "local_currency", "currency_conversion_rate", "network", "sub_network", "merchant_id", "webhook", "network_fees"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimulatePinDebitAuthRequest:
        """Create an instance of SimulatePinDebitAuthRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimulatePinDebitAuthRequest:
        """Create an instance of SimulatePinDebitAuthRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SimulatePinDebitAuthRequest.parse_obj(obj)

        _obj = SimulatePinDebitAuthRequest.parse_obj({
