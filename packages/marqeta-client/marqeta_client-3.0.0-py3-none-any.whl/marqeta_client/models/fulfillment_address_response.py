...
class FulfillmentAddressResponse(BaseModel):
    """
    ...
    __properties = ["first_name", "middle_name", "last_name", "address1", "address2", "city", "state", "zip", "postal_code", "country", "phone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FulfillmentAddressResponse:
        """Create an instance of FulfillmentAddressResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FulfillmentAddressResponse:
        """Create an instance of FulfillmentAddressResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FulfillmentAddressResponse.parse_obj(obj)

        _obj = FulfillmentAddressResponse.parse_obj({
