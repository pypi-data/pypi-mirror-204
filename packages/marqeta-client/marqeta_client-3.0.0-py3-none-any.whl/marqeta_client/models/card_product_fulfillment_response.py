...
class CardProductFulfillmentResponse(BaseModel):
    """
    CardProductFulfillmentResponse
    """
    shipping: Optional[ShippingInformationResponse] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardProductFulfillmentResponse:
        """Create an instance of CardProductFulfillmentResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardProductFulfillmentResponse:
        """Create an instance of CardProductFulfillmentResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CardProductFulfillmentResponse.parse_obj(obj)

        _obj = CardProductFulfillmentResponse.parse_obj({
            "shipping": ShippingInformationResponse.from_dict(obj.get("shipping")) if obj.get("shipping") is not None else None,
