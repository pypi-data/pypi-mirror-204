...
def option_logs(args):
    ...
    if check_modifiers('-logs',args,["-last","-tail","-store","-deletelogs","-limit","-limitinfo","-auto","-folder","-level","-loguser","-where","-inputfile","-file","-error","-noScreen","-allLimits"],help) == False: return
