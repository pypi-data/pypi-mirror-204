...
def queries(pc,d):
    ...
    for package in get_packages_in_LU(pc):
        ...
        soql_queries[package] = get_limit(pc,d,limit='SOQL queries')
 ...
 #   soql_queries_cmt_entry = d['cmtSOQLQueries'][0]
   ...
   # Qmct_estimate = soql_total_queries_entry - soql_queries_entry
    Qmct_estimate = soql_total_queries_entry - int(soql_queries['(default)'])

    return soql_queries,Qmct_estimate
...
def print_parsed_line(pc,d,parsed_line_index):
 ...
 #       if soql_queries_entry == 0 : soql_queries_entry = ''
        ...
        output = {
            ...
            'SOQL (default)':soql_queries_entry,
            'SOQL vlocity_cmt':soql_queries_cmt_entry,
