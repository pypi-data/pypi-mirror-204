...
def test_incompatibility_report():
    ...
    try:
        ...
        assert re.search(
            r"dirac_platform: [^-]+-{}".format(os_id()), err.output.decode()
        )
...
def test_path_to_project():
    try:
        ...
        raise SkipTest()  # only run on Python3
    ...
    data = {
        "MyProject_v1r1/InstallArea/{}/manifest.xml".format(
            platform
        ): '<?xml version="1.0" encoding="UTF-8"?><manifest><project name="MyProject" version="1.1" /></manifest>',
        "MyProject_v1r1/InstallArea/{}/MyProject.xenv".format(
            platform
        ): '<?xml version="1.0" encoding="UTF-8"?><env:config xmlns:env="EnvSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="EnvSchema EnvSchema.xsd "></env:config>',
    }
...
def test_cmake_version_lookup_to_cmake_version():
    ...
    data = {
        "MyProject_1.1/InstallArea/{}/manifest.xml".format(
            platform
        ): '<?xml version="1.0" encoding="UTF-8"?><manifest><project name="MyProject" version="1.1" /></manifest>',
        "MyProject_1.1/InstallArea/{}/MyProject.xenv".format(
            platform
        ): '<?xml version="1.0" encoding="UTF-8"?><env:config xmlns:env="EnvSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="EnvSchema EnvSchema.xsd "></env:config>',
    }
