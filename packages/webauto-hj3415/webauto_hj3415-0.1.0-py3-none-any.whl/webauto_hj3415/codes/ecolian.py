...
def select_course(driver: WebDriver, course: str):
    ...
    RESERV_ADDR = f'https://www.ecolian.or.kr/reser/reser.do?coDiv={course_id}'
...
def processing(course: str, date: str, mytime: str, myid: str, mypass: str, is_testing: bool = False, headless: bool = True):
    if is_testing:
