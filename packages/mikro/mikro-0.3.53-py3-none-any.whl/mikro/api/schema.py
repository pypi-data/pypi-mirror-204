...
from typing import Literal, Iterator, AsyncIterator, Optional, Dict, List, Tuple
...
class ChannelFragmentMapsOmero(Omero, BaseModel):
...
class ChannelFragmentMaps(BaseModel):
    ...
    id: ID
    omero: ChannelFragmentMapsOmero
...
class ChannelFragment(BaseModel):
    ...
    "The name of the channel"
    id: ID
    maps: Tuple[ChannelFragmentMaps, ...]
...
class DimensionMapFragmentChannel(BaseModel):
    """Channel(id, created_by, created_through, created_while, name, emmission_wavelength, excitation_wavelength, acquisition_mode, color)"""
...
class RepresentationFragmentOmeroMaps(BaseModel):
    """DimensionMap(id, created_by, created_through, created_while, omero, channel, dimension, index)"""
...
class RepresentationFragmentOmero(Omero, BaseModel):
    ...
    maps: Optional[Tuple[Optional[RepresentationFragmentOmeroMaps], ...]]
    affine_transformation: Optional[AffineMatrix] = Field(alias="affineTransformation")
...
class CreateChannelMutation(BaseModel):
    ...
    class Arguments(BaseModel):
        name: str
        emmission_wavelength: Optional[float]
        excitation_wavelength: Optional[float]
        acquisition_mode: Optional[str]
        color: Optional[str]

    class Meta:
        document = "fragment Channel on Channel {\n  name\n  id\n  maps {\n    id\n    omero {\n      id\n    }\n  }\n}\n\nmutation CreateChannel($name: String!, $emmissionWavelength: Float, $excitationWavelength: Float, $acquisitionMode: String, $color: String) {\n  createChannel(\n    name: $name\n    emmissionWavelength: $emmissionWavelength\n    excitationWavelength: $excitationWavelength\n    acquisitionMode: $acquisitionMode\n    color: $color\n  ) {\n    ...Channel\n  }\n}"
...
async def acreate_channel(
    name: str,
    emmission_wavelength: Optional[float] = None,
    ...
    """CreateChannel
     ...
     createChannel: Channel(id, created_by, created_through, created_while, name, emmission_wavelength, excitation_wavelength, acquisition_mode, color)


    Arguments:
        name (str): name
        emmission_wavelength (Optional[float], optional): emmissionWavelength.
    ...
    return (
        await aexecute(
            ...
            {
                "name": name,
                "emmissionWavelength": emmission_wavelength,
...
async def aget_channel(id: ID, rath: MikroRath = None) -> Optional[ChannelFragment]:
    """GetChannel
     ...
     channel: Channel(id, created_by, created_through, created_while, name, emmission_wavelength, excitation_wavelength, acquisition_mode, color)
...
async def asearch_channels(
    ...
    """SearchChannels
     ...
     options: Channel(id, created_by, created_through, created_while, name, emmission_wavelength, excitation_wavelength, acquisition_mode, color)
