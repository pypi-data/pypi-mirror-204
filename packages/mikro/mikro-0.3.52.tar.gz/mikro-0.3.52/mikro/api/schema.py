...
from typing import Iterator, List, Tuple, Dict, AsyncIterator, Literal, Optional
...
class CreateChannelMutation(BaseModel):
    ...
    class Meta:
        document = "fragment Channel on Channel {\n  name\n  id\n  maps {\n    id\n    omero {\n      id\n    }\n  }\n}\n\nmutation CreateChannel($name: String!, $emmissionWavelength: Float, $excitationWavelength: Float, $color: String) {\n  createChannel(\n    name: $name\n    emmissionWavelength: $emmissionWavelength\n    excitationWavelength: $excitationWavelength\n    color: $color\n  ) {\n    ...Channel\n  }\n}"
