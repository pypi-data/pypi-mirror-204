...
.hiddenports .table > div:first-child { text-align: center; background-color: #777; border: 1px solid black;}
...
.device .table.style > div:nth-child(2n+1) > div:first-child {background-color: ;border-left:white 1px solid grey;}
...
#logtable > div:nth-child(2n) { background-color: #777; border-bottom: 1px dotted black; }
...
@media screen, print {
	...
	ul.mktree  li { font-size: 11pt; font-weight: bold; }
	...
	ul.mktree  li ul li { helvetica; font-size: 11pt; font-weight: normal;}
}
@media print {
...
.installer #sidebar a:hover li.active, .nav a:hover li.active {background-color: white;border-color: #777;}
...
#sidebar .nav li a { border: 1px solid #777; margin: 0;}
