...
def buffer_item(key: str, value):
    ...
    rrdis.hset(_redis_buffer_key, nkey, json.dumps(value))
...
def get_buffer_item(key: str):
    ...
    if rrdis.hexists(_redis_buffer_key, nkey):
        return json.loads(rrdis.hget(_redis_buffer_key, nkey))
...
def remove_item(key: str):
    ...
    if has_item_key(key):
        ...
        rrdis.hdel(_redis_buffer_key, nkey)
