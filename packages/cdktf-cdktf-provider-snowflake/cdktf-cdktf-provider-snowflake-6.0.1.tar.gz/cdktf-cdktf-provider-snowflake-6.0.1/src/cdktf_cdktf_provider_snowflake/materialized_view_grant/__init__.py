...
class MaterializedViewGrant(
    ...
    def __init__(
        ...
        *,
        ...
        :param privilege: The privilege to grant on the current or future materialized view. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.62.0/docs/resources/materialized_view_grant#privilege MaterializedViewGrant#privilege}
        :param roles: Grants privilege to these roles. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.62.0/docs/resources/materialized_view_grant#roles MaterializedViewGrant#roles}
        ...
        :param shares: Grants privilege to these shares (only valid if on_future and on_all are false). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.62.0/docs/resources/materialized_view_grant#shares MaterializedViewGrant#shares}
