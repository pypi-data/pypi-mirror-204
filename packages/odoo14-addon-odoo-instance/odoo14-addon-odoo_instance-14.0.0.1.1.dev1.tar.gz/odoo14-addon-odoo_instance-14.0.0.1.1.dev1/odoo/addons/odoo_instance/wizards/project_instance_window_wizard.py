...
class ProjectInstanceWindowWizard(models.TransientModel):
    _name = 'project.instance.window.wizard'
    ...
    instance_id = fields.Many2one('project.instance', string='Instance', required=True)
