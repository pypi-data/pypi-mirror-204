...
class ProjectInstanceModule(models.Model):
    _name = 'project.instance.module'
    _description = 'Project Instance Module'
    ...
    version_ids = fields.One2many(
        'project.instance.module.version', 'module_id', string='Versions')
...
class ProjectInstanceModuleVersion(models.Model):
    _name = 'project.instance.module.version'
    _description = 'Project Instance Module Version'

    name = fields.Char(string='Version', required=True)
    module_id = fields.Many2one(
        'project.instance.module', string='Module', required=True, ondelete='cascade')
