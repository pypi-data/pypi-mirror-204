...
class AccountManagementApi(object):
    ...
    def change_password(self, current_password, new_password, **kwargs):  # noqa: E501
        """Change my password  # noqa: E501

        Change password for the logged in user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_password(current_password, new_password, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.change_password_with_http_info(current_password, new_password, **kwargs)  # noqa: E501
        else:
            (data) = self.change_password_with_http_info(current_password, new_password, **kwargs)  # noqa: E501
            return data

    def change_password_with_http_info(self, current_password, new_password, **kwargs):  # noqa: E501
        """Change my password  # noqa: E501

        Change password for the logged in user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.change_password_with_http_info(current_password, new_password, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['current_password', 'new_password', 'authorization']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/openapi/v1/changepassword', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_me(self, **kwargs):  # noqa: E501
        ...
        Get logged in user information  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_me_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='OpenApiGetMeResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_me(self, **kwargs):  # noqa: E501
        """Update my information  # noqa: E501
        ...
        :param async_req bool
        :param str authorization: Access credentials in the form of a jwt token.
        :param Properties1 properties: Information for updating the user details
        :return: OpenApiSuccessResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
