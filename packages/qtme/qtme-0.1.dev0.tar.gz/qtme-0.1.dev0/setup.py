...
PYPI_PACKAGE_NAME = 'qtme'
PROJECT_SHORT_DESC = 'Multimedia editor for PyQt/PySide'
PROJECT_WEB_SITE_URL = 'http://www.jdhp.org/software_en.html#qtme'
