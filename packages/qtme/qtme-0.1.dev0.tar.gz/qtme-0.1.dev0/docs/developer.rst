...
.. warning::
   ...
   `qtme` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `qtme`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `qtme-dev` with all
the Qt Multimedia Editor dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate qtme-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate qtme-dev``
...
type::
    ...
    conda list -n qtme-dev

If later you want to leave the `qtme-dev` virtual environment:
...
then on, all the Qt Multimedia Editor binaries and the library itself will be
...
.. _available on GitHub: https://gitlab.com/jdhp/qt-multimedia-editor
...
.. _TODO.md: https://gitlab.com/jdhp/qt-multimedia-editor/blob/master/TODO.md
