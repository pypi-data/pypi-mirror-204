    ...
    def enroll_detail(enroll_id: int = None, user_id: int = None, simple_return: bool = False):
        ...
        if not simple_return:
            ...
            for enroll_subitems_record in enroll_subitems_record_list:
                ...
                if record_id_to_subitems_record_map.get(enroll_subitems_record["enroll_record_id"], None) is None:
                ...
                if subitems_id_to_subitem_record_map.get(enroll_subitems_record["enroll_subitem_id"], None) is None:
