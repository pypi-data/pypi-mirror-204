...
class CardRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, can_update, identifiers, workflow_state, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            affiliations ([bool, date, datetime, dict, float, int, list, str, none_type]): The affiliations of the card request - the cardholders associations fetched from the University identity systems.. [optional]  # noqa: E501
