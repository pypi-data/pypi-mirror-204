...
Documentation is written in reStructuredText_ format
...
This tool uses the typer module to implement much of its functionality.
Familiarity with this will be of great benefit if you intend to contribute.
...
#. Clone this copy to your local disk::
    ...
    git clone https://github.com/lfit/releng-python-one-password.git
...
.. _repository: https://github.com/lfit/releng-python-one-password
.. _issue tracker: https://github.com/lfit/releng-python-one-password/issues
.. <-- end -->
