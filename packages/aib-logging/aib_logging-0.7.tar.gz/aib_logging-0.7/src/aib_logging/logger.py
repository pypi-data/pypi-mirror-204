    ...
    def data_stat_log(
        ...
        **kwargs
        ...
        Args:
            ...
            severity: Severities for logs,
                default is INFO
            min(dict): min value of dataset column in key,value pair
                default is empty dict {}
            max(dict) maximum value of dataset column in key,value pair
                default is empty dict {},
            mean(dict): mean value of dataset column in key,value pair
                default is empty dict {},
            std(dict): standard deviation value of dataset column in key,value pair,
                default is empty dict {},
            count(dict): values count of dataset column in key,value pair
                default is empty dict {},
