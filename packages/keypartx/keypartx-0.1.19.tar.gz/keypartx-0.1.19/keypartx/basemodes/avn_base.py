...
def coref(core_text):
  if crossLC == 0:
    ...
    predictor = Predictor(language="en_core_web_lg", device=-1, model_name="minilm")                     # add crosslingual-corefernce on 23.04.2023
    coref_text =predictor.predict(core_text)["resolved_text"]
