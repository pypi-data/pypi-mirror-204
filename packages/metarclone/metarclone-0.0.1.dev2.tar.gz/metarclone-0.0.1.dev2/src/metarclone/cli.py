...
def get_parser():
    ...
    def add_sync_arguments(parser: argparse.ArgumentParser):
        ...
        parser.add_argument('--no-base32-encode', action='store_true',
                            help="Do not encode filenames in base32 (some remotes may not support all filenames)")
...
def populate_sync_config(args: argparse.Namespace, conf: SyncConfig):
    ...
    conf.base32_encode = not args.no_base32_encode
