...
-- added 1 mm to lsy3_45 variable so that the iron yoke does not touch the conductor - E. Ravaioli - TE-MPE - 2019/11/11
...
-- added 1 mm to this variable so that the iron yoke does not touch the conductor - E. Ravaioli - TE-MPE - 2019/11/11
lsy3_45 = lsy3*(Sqrt(2)/2)+0.001;
