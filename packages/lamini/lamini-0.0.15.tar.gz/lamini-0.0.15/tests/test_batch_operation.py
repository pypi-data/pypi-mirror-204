...
class TestBatchOperation(unittest.TestCase):
    def test_batch(self):
        ...
        llm = LLM(name="test_batch")

        stories = llm(
            input=descriptors_batch, output_type=Story,
        )
    ...
    def test_batch_improve(self):
        ...
        llm = LLM(name="test_batch_improve")
...
You'll be surprised at how easy it is.
        ...
        descriptors_batch = [
            Inspiration(
                choices=information,
                preferences="I like to eat food"
            ),
            Inspiration(
                choices=information,
                preferences="I like sports"
            ),
        ]
        llm = LLM(name="test_batch_improve_long")

        activities = llm(
            input=descriptors_batch, output_type=Activity,
        )
