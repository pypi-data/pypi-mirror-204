...
class Experiment(NetworkObject):
    ...
    def createMetrics(self, values: List[Tuple[str, str, str]]) -> List[Metric]:
        """
            Creates List of Metric objects for current Experiment

            Parameters:
            values: List[Tuple[str, str, str]] -> Metric meta in this format ("name", "x_label", "y_label")
    ...
    def submitMetrics(self, metricValues: Dict[str, Tuple[float, float]]) -> bool:
        """
            Submits new values of metrics in current Experiment

            Parameters:
            metricValues: Dict[str, Tuple[float, float]] -> Values of metrics in this format {"name": x, y}
        """
