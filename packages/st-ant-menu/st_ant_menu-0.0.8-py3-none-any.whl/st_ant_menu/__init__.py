...
def st_ant_menu(menu_data = None, key="first_menu", defaultValue=None, defaultSelectedKeys=None, defaultOpenKeys=None, additionalHeight=100, multiple=False, css_styling=None, theme="light",menu_click=False, iconSize=15, modus = "inline") :
    """
