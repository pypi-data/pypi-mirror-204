...
class GRPCClient(
    ...
    def connect(self):
        self.channel_mainnet = grpc.insecure_channel(
            f"{self.hosts[NET.MAINNET][self.host_index[NET.MAINNET]]['host']}:{self.hosts[NET.MAINNET][self.host_index[NET.MAINNET]]['port']}"
        )
        self.channel_testnet = grpc.insecure_channel(
            f"{self.hosts[NET.TESTNET][self.host_index[NET.TESTNET]]['host']}:{self.hosts[NET.TESTNET][self.host_index[NET.TESTNET]]['port']}"
        )
