...
from object_detection_aug import utils_py as utils_py
from object_detection_aug import logging_util as logging_util
...
def jpg_converter(folder:os.path) -> None:
    ...
    '''
    This is a important function for this code.
...
def converter(path:os.path,resize_im:int=416,keep_aspect_ratio:bool=True,image_jpg_converter:bool=True) -> None:
    ...
    if type(keep_aspect_ratio) == bool:
        pass
    else:
        raise TypeError('Please provide boolean in keep asepect ratio')
