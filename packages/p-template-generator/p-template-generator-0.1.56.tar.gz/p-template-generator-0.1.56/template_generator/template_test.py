...
def test(searchPath):
    ...
    config = {
        ...
        "template":os.path.join(rootDir, "res", "template"),
        "params":{},
    ...
    binaryPath = template.getBinary(searchPath)        
    command = f'{binaryPath} --config {os.path.join(rootDir, "res", "param.config")} --call_mesa'
