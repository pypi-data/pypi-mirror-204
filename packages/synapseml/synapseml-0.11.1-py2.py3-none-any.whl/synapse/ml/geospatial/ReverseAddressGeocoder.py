...
class ReverseAddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ReverseAddressGeocoder_60ad1cc2a626_error",
        ...
        outputCol="ReverseAddressGeocoder_60ad1cc2a626_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReverseAddressGeocoder_60ad1cc2a626_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReverseAddressGeocoder_60ad1cc2a626_output")
