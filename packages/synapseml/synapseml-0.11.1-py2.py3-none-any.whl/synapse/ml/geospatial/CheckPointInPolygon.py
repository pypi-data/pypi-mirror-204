...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_0a5a695576a9_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_0a5a695576a9_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_0a5a695576a9_error")
        self._setDefault(outputCol="CheckPointInPolygon_0a5a695576a9_output")
