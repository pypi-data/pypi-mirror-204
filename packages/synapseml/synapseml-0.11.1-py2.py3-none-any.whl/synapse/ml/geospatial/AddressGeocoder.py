...
class AddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddressGeocoder_68b9117012d7_error",
        initialPollingDelay=300,
        maxPollingRetries=1000,
        outputCol="AddressGeocoder_68b9117012d7_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AddressGeocoder_68b9117012d7_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AddressGeocoder_68b9117012d7_output")
