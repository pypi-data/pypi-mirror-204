...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_0b377e9a6eba_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_0b377e9a6eba_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_0b377e9a6eba_error")
        self._setDefault(outputCol="AddDocuments_0b377e9a6eba_output")
