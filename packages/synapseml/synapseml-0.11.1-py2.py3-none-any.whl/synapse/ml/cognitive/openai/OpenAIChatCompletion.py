...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_b0f95da09860_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_b0f95da09860_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_b0f95da09860_error")
        self._setDefault(outputCol="OpenAIChatCompletion_b0f95da09860_output")
