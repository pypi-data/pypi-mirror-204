...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_12891b3736d9_error",
        handler=None,
        outputCol="OpenAIEmbedding_12891b3736d9_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_12891b3736d9_error")
        self._setDefault(outputCol="OpenAIEmbedding_12891b3736d9_output")
