...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_473c1a695bd9_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_473c1a695bd9_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_473c1a695bd9_error")
        self._setDefault(outputCol="OpenAICompletion_473c1a695bd9_output")
