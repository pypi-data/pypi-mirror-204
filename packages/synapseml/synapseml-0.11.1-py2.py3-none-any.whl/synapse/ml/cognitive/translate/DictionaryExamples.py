...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_889127ebcada_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_889127ebcada_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_889127ebcada_error")
        self._setDefault(outputCol="DictionaryExamples_889127ebcada_output")
