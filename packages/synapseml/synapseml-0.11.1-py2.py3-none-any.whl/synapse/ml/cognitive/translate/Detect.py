...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_50d6ccf768c5_error",
        handler=None,
        outputCol="Detect_50d6ccf768c5_output",
        ...
        self._setDefault(errorCol="Detect_50d6ccf768c5_error")
        self._setDefault(outputCol="Detect_50d6ccf768c5_output")
