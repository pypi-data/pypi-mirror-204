...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_075ed7ec2453_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_075ed7ec2453_output",
        ...
        self._setDefault(errorCol="Transliterate_075ed7ec2453_error")
        self._setDefault(outputCol="Transliterate_075ed7ec2453_output")
