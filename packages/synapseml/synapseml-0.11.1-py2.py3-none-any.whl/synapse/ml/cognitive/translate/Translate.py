...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_6efd04143aa2_error",
        fromLanguage=None,
        ...
        outputCol="Translate_6efd04143aa2_output",
        ...
        self._setDefault(errorCol="Translate_6efd04143aa2_error")
        self._setDefault(outputCol="Translate_6efd04143aa2_output")
