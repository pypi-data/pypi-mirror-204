...
class DocumentTranslator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DocumentTranslator_550fe929c33d_error",
        filterPrefix=None,
        ...
        outputCol="DocumentTranslator_550fe929c33d_output",
        pollingDelay=300,
        serviceName=None,
        sourceLanguage=None,
        ...
        self._setDefault(errorCol="DocumentTranslator_550fe929c33d_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DocumentTranslator_550fe929c33d_output")
