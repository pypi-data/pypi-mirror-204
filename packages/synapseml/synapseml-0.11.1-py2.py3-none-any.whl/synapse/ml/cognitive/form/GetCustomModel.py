...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_30d1f69af4f2_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_30d1f69af4f2_output",
        ...
        self._setDefault(errorCol="GetCustomModel_30d1f69af4f2_error")
        self._setDefault(outputCol="GetCustomModel_30d1f69af4f2_output")
