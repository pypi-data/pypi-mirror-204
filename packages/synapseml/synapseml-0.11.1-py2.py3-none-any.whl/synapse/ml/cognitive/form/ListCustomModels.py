...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_2ec5ac39563e_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_2ec5ac39563e_output",
        ...
        self._setDefault(errorCol="ListCustomModels_2ec5ac39563e_error")
        self._setDefault(outputCol="ListCustomModels_2ec5ac39563e_output")
