...
class SimpleDetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        errorCol="SimpleDetectMultivariateAnomaly_b08fee48f09e_error",
        handler=None,
        ...
        modelId=None,
        outputCol="SimpleDetectMultivariateAnomaly_b08fee48f09e_output",
        pollingDelay=300,
        startTime=None,
        ...
        self._setDefault(errorCol="SimpleDetectMultivariateAnomaly_b08fee48f09e_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="SimpleDetectMultivariateAnomaly_b08fee48f09e_output")
