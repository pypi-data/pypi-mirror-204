...
class SimpleDetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SimpleDetectAnomalies_321324c10f63_error",
        granularity=None,
        granularityCol=None,
        groupbyCol=None,
        handler=None,
        ...
        outputCol="SimpleDetectAnomalies_321324c10f63_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="SimpleDetectAnomalies_321324c10f63_error")
        self._setDefault(outputCol="SimpleDetectAnomalies_321324c10f63_output")
