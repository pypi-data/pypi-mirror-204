...
class DetectLastAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastAnomaly_554eed6db620_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectLastAnomaly_554eed6db620_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectLastAnomaly_554eed6db620_error")
        self._setDefault(outputCol="DetectLastAnomaly_554eed6db620_output")
