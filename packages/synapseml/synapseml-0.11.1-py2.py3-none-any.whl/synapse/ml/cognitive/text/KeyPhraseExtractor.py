...
class KeyPhraseExtractor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractor_244eec8b4c45_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="KeyPhraseExtractor_244eec8b4c45_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="KeyPhraseExtractor_244eec8b4c45_error")
        self._setDefault(outputCol="KeyPhraseExtractor_244eec8b4c45_output")
