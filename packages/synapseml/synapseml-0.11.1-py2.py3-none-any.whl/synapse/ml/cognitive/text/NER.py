...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_7fc4808e3ff6_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_7fc4808e3ff6_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_7fc4808e3ff6_error")
        self._setDefault(outputCol="NER_7fc4808e3ff6_output")
