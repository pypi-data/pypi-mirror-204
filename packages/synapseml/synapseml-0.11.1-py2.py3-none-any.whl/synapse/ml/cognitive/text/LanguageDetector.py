...
class LanguageDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetector_59cc30bc56fe_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="LanguageDetector_59cc30bc56fe_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="LanguageDetector_59cc30bc56fe_error")
        self._setDefault(outputCol="LanguageDetector_59cc30bc56fe_output")
