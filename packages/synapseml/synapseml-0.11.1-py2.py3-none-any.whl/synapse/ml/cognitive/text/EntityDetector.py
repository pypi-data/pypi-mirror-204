...
class EntityDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetector_3788ba4e9937_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="EntityDetector_3788ba4e9937_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="EntityDetector_3788ba4e9937_error")
        self._setDefault(outputCol="EntityDetector_3788ba4e9937_output")
