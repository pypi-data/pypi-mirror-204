...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_da4533996d7a_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_da4533996d7a_output",
        ...
        self._setDefault(errorCol="DetectFace_da4533996d7a_error")
        self._setDefault(outputCol="DetectFace_da4533996d7a_output")
