...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_381015fb12be_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_381015fb12be_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_381015fb12be_error")
        self._setDefault(outputCol="FindSimilarFace_381015fb12be_output")
