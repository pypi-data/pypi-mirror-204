...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_552195fecdc6_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_552195fecdc6_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_552195fecdc6_error")
        self._setDefault(outputCol="VerifyFaces_552195fecdc6_output")
