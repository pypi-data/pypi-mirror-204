...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_e3c69f84b47b_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_e3c69f84b47b_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_e3c69f84b47b_error")
        self._setDefault(outputCol="IdentifyFaces_e3c69f84b47b_output")
