...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_c8908e0f6b56_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_c8908e0f6b56_output",
        ...
        self._setDefault(errorCol="GroupFaces_c8908e0f6b56_error")
        self._setDefault(outputCol="GroupFaces_c8908e0f6b56_output")
