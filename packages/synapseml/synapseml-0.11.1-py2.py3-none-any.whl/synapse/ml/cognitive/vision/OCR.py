...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_1946c2db7d3d_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_1946c2db7d3d_output",
        ...
        self._setDefault(errorCol="OCR_1946c2db7d3d_error")
        self._setDefault(outputCol="OCR_1946c2db7d3d_output")
