...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_2ecc1c476b1e_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_2ecc1c476b1e_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_2ecc1c476b1e_error")
        self._setDefault(outputCol="AnalyzeImage_2ecc1c476b1e_output")
