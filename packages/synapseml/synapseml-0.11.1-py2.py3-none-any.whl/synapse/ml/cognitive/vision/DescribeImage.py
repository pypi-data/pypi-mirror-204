...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_b44b6d2698ec_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_b44b6d2698ec_output",
        ...
        self._setDefault(errorCol="DescribeImage_b44b6d2698ec_error")
        self._setDefault(outputCol="DescribeImage_b44b6d2698ec_output")
