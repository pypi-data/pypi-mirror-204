...
class RecognizeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="RecognizeText_4cc619ca7d7b_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="RecognizeText_4cc619ca7d7b_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="RecognizeText_4cc619ca7d7b_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="RecognizeText_4cc619ca7d7b_output")
