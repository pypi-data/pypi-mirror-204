...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_e58833620902_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_e58833620902_output",
        ...
        self._setDefault(errorCol="TagImage_e58833620902_error")
        self._setDefault(outputCol="TagImage_e58833620902_output")
