...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeakerEmotionInference_d3d0ae3aa572_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_d3d0ae3aa572_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_d3d0ae3aa572_error")
        self._setDefault(outputCol="SpeakerEmotionInference_d3d0ae3aa572_output")
