...
class SpeechToText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeechToText_f79f7d38ef11_error",
        format=None,
        formatCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="SpeechToText_f79f7d38ef11_output",
        profanity=None,
        profanityCol=None,
        ...
        self._setDefault(errorCol="SpeechToText_f79f7d38ef11_error")
        self._setDefault(outputCol="SpeechToText_f79f7d38ef11_output")
