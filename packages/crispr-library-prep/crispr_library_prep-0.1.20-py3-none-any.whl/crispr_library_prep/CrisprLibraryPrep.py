...
def process_sample_sheet(sample_sheet: pd.DataFrame, target_coverage_percentage: float, max_target_coverage_input: float, suggested_target_coverage_amounts: List[Union[float, int]], read_intervals_count: int =50, approximation=False, max_reads_multiplier: Union[float, int]=3, cores=1):
    def process_row(row):
