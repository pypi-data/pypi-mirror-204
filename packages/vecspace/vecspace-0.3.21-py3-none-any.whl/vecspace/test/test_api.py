...
from vecspace.api.types import QueryResult
from vecspace.config import Settings
import vecspace.server.fastapi
import pytest
import time
import tempfile
import os
...
def fastapi_integration_api():
    return vecspace.Client()  # configured by environment variables
...
def run_server():
    ...
    server = vecspace.server.fastapi.FastAPI(settings)
