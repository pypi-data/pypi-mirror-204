...
import vecspace
import vecspace.server
from vecspace.errors import (
    NoDatapointsException,
    InvalidDimensionException,
    NotEnoughElementsException,
)
from vecspace.server.fastapi.types import (
    AddEmbedding,
    DeleteEmbedding,
    GetEmbedding,
    QueryEmbedding,
...
import logging
from vecspace.telemetry import ServerContext, Telemetry
...
class FastAPI(vecspace.server.Server):
    def __init__(self, settings):
        super().__init__(settings)
        Telemetry.SERVER_CONTEXT = ServerContext.FASTAPI
        self._app = fastapi.FastAPI(debug=True)
        self._api = vecspace.Client(settings)
