...
from vecspace.utils.embedding_functions import SentenceTransformerEmbeddingFunction
...
assert type(collection) == vecspace.api.models.Collection.Collection
print(collection)
...
assert type(getcollection) == vecspace.api.models.Collection.Collection
print(getcollection)
...
assert type(collections_list[0]) == vecspace.api.models.Collection.Collection
