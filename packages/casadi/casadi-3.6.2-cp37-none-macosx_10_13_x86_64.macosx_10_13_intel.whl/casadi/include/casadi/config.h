...
#define CASADI_VERSION_STRING "3.6.2"
#define CASADI_GIT_REVISION "896ebb1083311cfdb392f411ba83385080a05ed3"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.6.1-8.896ebb108"  // NOLINT(whitespace/line_length)
