...
class FiveTranConnector:
    ...
    def from_dict(obj: Any) -> 'FiveTranConnector':
        ...
        return FiveTranConnector(config, connector_logs_url, connector_name, connector_type_id, connector_type_name, connector_url, created_at, paused, schema_metadata, status, succeeded_at)
