...
from alice_bus_client.message import Message, CollectionMessage
from alice_bus_client.util import create_echo_function
...
class MessageBusClient:
    """The Alice Messagebus Client

    The Messagebus client connects to the Alice messagebus service
    ...
    def on_message(self, *args):
        ...
        Args:
            message (str): serialized Alice Message
        """
        if len(args) == 1:
            message = args[0]
        else:
    ...
    def emit(self, message):
        ...
        event emitter and onto the Alice websocket for other processes.
