...
class LogQSClient:
    def __init__(
        ...
        self._aws_access_key_id = self._env_config.get("AWS_ACCESS_KEY_ID")
        self._aws_secret_access_key = self._env_config.get("AWS_SECRET_ACCESS_KEY")
        self._aws_region = self._env_config.get("AWS_DEFAULT_REGION")
        self._aws_session_token = self._env_config.get("AWS_SESSION_TOKEN")
        self._aws_endpoint_url = self._env_config.get("AWS_ENDPOINT_URL")
