...
if [[ ! -d $(rustc --print target-libdir --target armv7-unknown-linux-gnueabihf) ]]; then rustup target add armv7-unknown-linux-gnueabihf; fi
echo "::endgroup::"
maturin build --target armv7-unknown-linux-gnueabihf -i python3.11 --release --out dist