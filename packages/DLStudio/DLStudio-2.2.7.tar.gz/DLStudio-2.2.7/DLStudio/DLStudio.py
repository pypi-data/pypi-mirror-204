...
__date__      = '2023-April-20'                   
__url__       = 'https://engineering.purdue.edu/kak/distDLS/DLStudio-2.2.7.html'
...
CHANGE LOG:
  ...
  Version 2.2.7:
    ...
    choice for the hyperparameters, the model you are training could suddenly
    diverge (which is something akin to mode collapse in training a GAN). If you
    have to wait until the end of training to see such failures, that can be very
