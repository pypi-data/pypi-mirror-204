from typing import Dict, TypedDict, List, Union, Literal, Any, Tuple
...
class _BaseGen991278(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
