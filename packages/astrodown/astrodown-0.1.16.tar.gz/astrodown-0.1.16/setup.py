...
{'': ['*'],
 'astrodown.templates': ['basic/*',
                         ...
                         '}}/public/dashboard/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/basic/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/basic/edit/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/jquery.terminal/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/jquery.terminal/assets/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/jquery.terminal/bin/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/jquery.terminal/css/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/jquery.terminal/js/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/pyodide/*',
                         'full/{{ cookiecutter.project_name '
                         '}}/public/dashboard/shinylive/pyright/*',
