...
class MongoUser(User):
    ...
    def from_dict(cls, rec: dict) -> "MongoUser":
        record = MongoUser(rec.get(_UID_KEY), rec.get(_PASSWORD_KEY), is_encrypted=True, creation_date=rec.get(_CREATION_DATE_KEY))
...
class MongoUserRepository(UserRepository):
    ...
    def create_user(self, uid: str, password: str, nickname: str = None, full_name: str = None):
        user = MongoUser(uid, password, is_encrypted=False, nickname=nickname, full_name=full_name)
