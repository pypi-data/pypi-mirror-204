...
class Analyst:
    ...
    def supervised_edgewise_builder(
        ...
        *,
        ...
        standardize: bool = False,
        normalize: bool = True,
        edge_combination_method: Optional[Union[
        ...
        if edge_combination_method:
            if not isinstance(edge_combination_method, (ConcatEdgeCombinationMethod,
                                                        ProductEdgeCombinationMethod)):
    ...
    def unsupervised_edgewise_builder(
        ...
        *,
        ...
        if loss_fn not in pgx_types.UNSUPERVISED_EDGEWISE_LOSS_FUNCTIONS.keys():
            raise ValueError(
                INVALID_OPTION.format(
                    var='loss_fn',
                    opts=', '.join(pgx_types.UNSUPERVISED_EDGEWISE_LOSS_FUNCTIONS.keys())
                )
            )
        java_handler(builder.setLossFunction,
                     [pgx_types.UNSUPERVISED_EDGEWISE_LOSS_FUNCTIONS[loss_fn]])
