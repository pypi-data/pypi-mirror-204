...
def list_audio_backends() -> List[str]:
    ...
    # if _mod_utils.is_sox_available(): #TODO sox Adaptation
...
def set_audio_backend(backend: Optional[str]):
    ...
    if backend is None:
        module = no_backend
    # elif backend == "sox_io": #TODO sox Adaptation
...
def _init_audio_backend():
    ...
    # if "sox_io" in backends: #TODO sox Adaptation
...
def get_audio_backend() -> Optional[str]:
    ...
    if torchaudio.load == no_backend.load:
        return None
    # if torchaudio.load == sox_io_backend.load: # #TODO sox Adaptation
    #     return "sox_io"
