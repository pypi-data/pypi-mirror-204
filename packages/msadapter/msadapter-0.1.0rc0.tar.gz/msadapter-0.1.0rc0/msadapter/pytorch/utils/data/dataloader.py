...
class _MultiProcessingDataLoaderIter(_BaseDataLoaderIter):
    def __init__(self, loader):
        ...
        self._worker_result_queue = _SharedQueue(loader.num_workers * loader.prefetch_factor) # a queue using shared memory for better performance.
            ...
            try:
                ...
                if e.errno == errno.EMFILE:
                    raise RuntimeError(
                        ...
                        " workers is no longer possible.") from None
            raise
