...
import platform
from ibm_dfo_sdk.version import __version__

HEADER_NAME_USER_AGENT = 'User-Agent'
SDK_NAME = 'dfo-python-sdk.git'
...
def get_sdk_headers(service_name, service_version, operation_id):
    ...
    dfo-python-sdk.git/0.0.1 (lang=python; arch=x86_64; os=Linux; python.version=3.7.4)

    In the example above, the analytics tool will parse the user-agent header and
    use the following properties:
    "dfo-python-sdk.git" - the name of your sdk
