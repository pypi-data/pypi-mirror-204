...
from chatllm.utils import textsplitter, llm_load4chat

import streamlit as st
from appzoo.streamlit_app.utils import display_pdf, reply4input

st.set_page_config('🔥ChatLLM', layout='wide')
...
qa = ChatBase(chat_func=get_chat_func())
...
if st.button("发送", key="predict"):
    with st.spinner("AI正在思考，请稍等........"):
        ...
        st.session_state["state"] = reply4input(text, history, container=container, reply_func=qa)
