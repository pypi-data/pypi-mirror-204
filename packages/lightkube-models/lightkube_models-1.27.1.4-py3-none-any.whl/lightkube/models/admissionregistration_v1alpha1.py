...
class ParamRef(DataclassDictMixIn):
    """ParamRef references a parameter resource
      ...
      * **name** ``str`` - *(optional)* Name of the resource being referenced.
      * **namespace** ``str`` - *(optional)* Namespace of the referenced resource. Should be empty for the cluster-scoped
        resources
    """
    name: 'str' = None
    namespace: 'str' = None
