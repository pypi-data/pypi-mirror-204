...
task_specific_params = {
    ...
    "summarization_frost": {"length_penalty": 0.8, "max_length": 128, "max_position_embeddings": 1024},
...
def convert_pegasus_ckpt_to_pytorch(ckpt_path: str, save_dir: str):
    ...
    tok = PegasusTokenizer.from_pretrained("google/pegasus-cnn_dailymail", model_max_length=desired_max_model_length)
...
if __name__ == "__main__":
    ...
    tf_ckpt_path="/home/dingyx/.cache/frost/frost_composition_sampling_frost_finetuned_ckpts_cnn_dailymail_frost_ecp_model.ckpt-82000"
    save_dir="/home/dingyx/.cache/frost"
    dataset = Path(tf_ckpt_path).parent.name
    save_dir = os.path.join("pegasus", dataset)
    convert_pegasus_ckpt_to_pytorch(tf_ckpt_path, save_dir)