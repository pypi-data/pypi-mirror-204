...
class GetModelConfigsResponse(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ProjectModelConfigResponse']:
            return ProjectModelConfigResponse

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ProjectModelConfigResponse'], typing.List['ProjectModelConfigResponse']],
    ...
    def __getitem__(self, i: int) -> 'ProjectModelConfigResponse':
