...
class ExperimentGenerate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "inputs", "experiment_id", "source", "provider_api_keys", "num_samples", "logprobs", "stream", "suffix", "user", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "inputs", "experiment_id", "source", "provider_api_keys", "num_samples", "logprobs", "stream", "suffix", "user", "metadata", ], str]):
