...
class ChatModelConfigRequest(
    ...
    Chat the default endpoint to use for chat and update prompt template message
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model", "provider", "endpoint", "prompt_template", "chat_template", "temperature", "max_tokens", "top_p", "stop", "presence_penalty", "frequency_penalty", "other", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model", "provider", "endpoint", "prompt_template", "chat_template", "temperature", "max_tokens", "top_p", "stop", "presence_penalty", "frequency_penalty", "other", ], str]):
