...
import humanloop
from humanloop.paths.projects_id_model_configs import get
from humanloop import configuration, schemas, api_client

from .. import ApiTestMixin


class TestProjectsIdModelConfigs(ApiTestMixin, unittest.TestCase):
    """
    ProjectsIdModelConfigs unit test stubs
