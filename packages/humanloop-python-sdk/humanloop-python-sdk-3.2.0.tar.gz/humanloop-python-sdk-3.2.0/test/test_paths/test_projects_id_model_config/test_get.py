...
import humanloop
from humanloop.paths.projects_id_model_config import get
from humanloop import configuration, schemas, api_client

from .. import ApiTestMixin


class TestProjectsIdModelConfig(ApiTestMixin, unittest.TestCase):
    """
    ProjectsIdModelConfig unit test stubs
