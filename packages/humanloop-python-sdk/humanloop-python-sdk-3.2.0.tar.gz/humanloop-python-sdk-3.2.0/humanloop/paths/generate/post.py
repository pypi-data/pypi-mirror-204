...
# body param
SchemaForRequestBodyApplicationJson = GenerateRequest


request_body_generate_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GenerateResponse
...
class BaseApi(api_client.Api):
    ...
    def _generate_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_request.serialize(body, content_type)
