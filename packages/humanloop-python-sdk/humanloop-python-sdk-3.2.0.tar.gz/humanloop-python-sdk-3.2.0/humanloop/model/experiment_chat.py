...
class ExperimentChat(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "messages", "provider_api_keys", "experiment_id", "inputs", "source", "num_samples", "stream", "user", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "messages", "provider_api_keys", "experiment_id", "inputs", "source", "num_samples", "stream", "user", "metadata", ], str]):
