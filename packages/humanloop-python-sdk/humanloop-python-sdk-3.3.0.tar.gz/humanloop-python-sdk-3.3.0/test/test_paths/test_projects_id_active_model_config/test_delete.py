...
import humanloop
from humanloop.paths.projects_id_active_model_config import delete
from humanloop import configuration, schemas, api_client

from .. import ApiTestMixin


class TestProjectsIdActiveModelConfig(ApiTestMixin, unittest.TestCase):
    """
    ProjectsIdActiveModelConfig unit test stubs
        Delete Active Model Config
    """
