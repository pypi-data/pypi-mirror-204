...
# body param
SchemaForRequestBodyApplicationJson = SubmitRequest


request_body_submit_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SubmitResponse
...
class BaseApi(api_client.Api):
    ...
    def _submit_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_submit_request.serialize(body, content_type)
