...
# body param
SchemaForRequestBodyApplicationJson = UpdateFeedbackTypesRequest


request_body_update_feedback_types_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_feedback_types_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_feedback_types_request.serialize(body, content_type)
