...
class LogRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "output", "trial_id", "inputs", "messages", "source", "model_config", "metadata", "feedback", "created_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "output", "trial_id", "inputs", "messages", "source", "model_config", "metadata", "feedback", "created_at", ], str]):
