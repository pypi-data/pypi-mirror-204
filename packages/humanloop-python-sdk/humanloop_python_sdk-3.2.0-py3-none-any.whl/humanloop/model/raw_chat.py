...
class RawChat(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "messages", "provider_api_keys", "model_config", "inputs", "source", "num_samples", "stream", "user", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "messages", "provider_api_keys", "model_config", "inputs", "source", "num_samples", "stream", "user", "metadata", ], str]):
