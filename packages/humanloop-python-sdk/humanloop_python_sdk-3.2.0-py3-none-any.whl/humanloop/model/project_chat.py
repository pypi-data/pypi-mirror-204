...
class ProjectChat(
    ...
    Alias for BaseChat that providers a better name for the consumer of docs
    """
    ...
    provider_api_keys: MetaOapg.properties.provider_api_keys
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project", "messages", "provider_api_keys", "inputs", "source", "num_samples", "stream", "user", "metadata", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["provider_api_keys"]) -> MetaOapg.properties.provider_api_keys: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project", "messages", "provider_api_keys", "inputs", "source", "num_samples", "stream", "user", "metadata", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        provider_api_keys: typing.Union[MetaOapg.properties.provider_api_keys, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
